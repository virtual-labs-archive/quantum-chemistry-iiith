...
$css_js   = "http://deploy.virtual-labs.ac.in/labs/ccnsb04/"; 
$lab_url  = "http://deploy.virtual-labs.ac.in/labs/ccnsb04/index.php";
$exp_url  =  "http://deploy.virtual-labs.ac.in/labs/ccnsb04/exp10/index.php";
$base_url = $exp_url;
