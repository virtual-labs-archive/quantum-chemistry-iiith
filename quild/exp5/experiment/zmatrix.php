				...
				<table border="0">
					<tr>
						<td><?php $structure_img = $file_base."/".$name."/".$name.".png" ;?>
							...
							<div style="text-align: center;">Follow the convertion of the
								atom odering</div>
						</td>
						<td width="70px"></td>
						<td><?php $jmol_file = $file_base."/".$name."/".$file_names[$file_index]; ?>
				...
				<div style="height: 230px">
					<center>
						<div id="zmatrix">
							<div id="heading">
								<div id="z-mat"
									style='color: black; font-family: "Times New Roman", Times, serif; font-size: 1.5em;'>
